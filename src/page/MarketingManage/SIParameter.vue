<template>
    <section>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>签到参数查询</el-breadcrumb-item>
        </el-breadcrumb>
    ...
    <el-col :span="24" style="padding-bottom: 0px;background-color: #fafafa;height: 50px;margin-top: 10px;">
        ...
        <el-table :data="tableData" border :header-cell-style="{'background-color': '#fafafa'}" style="width: 100%;margin-top: 70px;;">
            <el-table-column prop="id" label="参数编号"></el-table-column>
            <el-table-column prop="days" label="连续签到天数"></el-table-column>
            <el-table-column prop="baseIntegral" label="基础积分"></el-table-column>
            <el-table-column prop="extraIntegral" label="额外积分"></el-table-column>
            <el-table-column prop="create" label="创建人"></el-table-column>
            <el-table-column prop="update" label="修改人"></el-table-column>
        </el-table>
