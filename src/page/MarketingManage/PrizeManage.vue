<template>
    ...
    <el-col :span="24" style="padding-bottom: 0px;background-color: #fafafa;height: 50px;margin-top: 10px;">
        ...
        <el-table :data="tableData" border :header-cell-style="{'background-color': '#fafafa'}" style="width: 100%;margin-top: 70px;;">
            ...
            <el-table-column prop="prizeType" label="奖品类型"></el-table-column>
            <el-table-column prop="prizeName" label="奖品名称"></el-table-column>
            <el-table-column prop="winProb" label="中奖概率"></el-table-column>
            <el-table-column prop="oneWinNum" label="每次中奖数量"></el-table-column>
            <el-table-column prop="totalNum" label="总数量"></el-table-column>
            <el-table-column prop="surplusNum" label="剩余数量"></el-table-column>
            <el-table-column prop="isFree" label="是否免费抽中"></el-table-column>
            <el-table-column prop="isCarousel" label="是否轮播"></el-table-column>
            <el-table-column prop="img" label="奖品图片"></el-table-column>
        </el-table>
